...
import { getDatabase, ref, set, push, onValue, off, remove, get, child, update, runTransaction } from 'firebase/database';
...
export { db, ref, set, push, onValue, off, remove, get, child, update, runTransaction };
